...
namespace dotnet_g033.Tests.Data
{
    public class DummyApplicationDbContext
    {
        ...
        public DummyApplicationDbContext()
        {
            ...
            Sessie2 = new Sessie("sessie2", new DateTime(2020, 2, 21, 10, 30, 0), new DateTime(2020, 2, 21, 12, 30, 0), false, 10, 0);
            Sessie3 = new Sessie("sessie3", new DateTime(2020, 2, 22, 16, 0, 0), new DateTime(2020, 2, 22, 17, 0, 0), true, 30, 0);
